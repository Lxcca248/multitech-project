...
Página de Estatísticas com gráficos detalhados de visitas diárias e cadastros mensais.

Página de Usuários que lista usuários reais via API REST (backend Node.js).

Página de Configurações para personalização do usuário (nome para exibição e notificações).
